...
osm2pgsql  -S customised.style --database $newdb --slim --create --username $dbusername --hstore --number-processes $MYCORES --unlogged --cache $cachesize australia-latest.osm.pbf
